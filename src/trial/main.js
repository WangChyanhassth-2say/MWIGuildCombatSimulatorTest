...
const trialMessages = {
    zh: {
        ...
        update20260717ApiImport: "新增 API 配装导入，API 固定预设以金色显示；复制 API 预设后会转为普通绿色固定预设。",
    ...
    en: {
        ...
        update20260717ApiImport: "Added API build import. API fixed presets are shown in gold, and copied API presets become regular green fixed presets.",
