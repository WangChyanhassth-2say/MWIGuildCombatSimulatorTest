...
class Player extends CombatUnit {
    ...
    static createFromDTO(dto) {
        ...
        player.guildTrialRegenBonus = dto.guildTrialRegenBonus ?? 0;
    ...
    updateCombatDetails() {
        ...
        if (this.guildTrialRegenBonus > 0) {
            this.combatDetails.combatStats.hpRegenPer10 += this.guildTrialRegenBonus;
            this.combatDetails.combatStats.mpRegenPer10 += this.guildTrialRegenBonus;
        }
    }
}
